...
__attribute__((visibility("default"))) __thread int current_token;
...
static const yytype_int16 yyrline[] =
{
    ...
    1123,  1125,  1127,  1134,  1136,  1138,  1142,  1143,  1146,  1148,
    1150,  1154,  1155,  1164,  1177,  1193,  1208,  1210,  1212,  1219,
    1222,  1226,  1228,  1234,  1240,  1260,  1283,  1285,  1308,  1312,
    1314,  1316,  1318
};
#endif
...
#line 2550 "y.tab.c"
  ...
  case 53:
#line 721 "../parse/parse.y"
                        { (yyval.element).word = (yyvsp[0].word); (yyval.element).redirect = 0; }
#line 2556 "y.tab.c"
    break;

  case 54:
#line 723 "../parse/parse.y"
                        { (yyval.element).word = (yyvsp[0].word); (yyval.element).redirect = 0; }
#line 2562 "y.tab.c"
    break;

  case 55:
#line 725 "../parse/parse.y"
                        { (yyval.element).redirect = (yyvsp[0].redirect); (yyval.element).word = 0; }
#line 2568 "y.tab.c"
    break;

  case 56:
#line 729 "../parse/parse.y"
                        {
...
#line 2589 "y.tab.c"
  ...
  case 58:
#line 744 "../parse/parse.y"
                        { (yyval.command) = make_simple_command ((yyvsp[0].element), (COMMAND *)NULL); }
#line 2595 "y.tab.c"
    break;

  case 59:
#line 746 "../parse/parse.y"
                        { (yyval.command) = make_simple_command ((yyvsp[0].element), (yyvsp[-1].command)); }
#line 2601 "y.tab.c"
    break;

  case 60:
#line 750 "../parse/parse.y"
                        { (yyval.command) = clean_simple_command ((yyvsp[0].command)); }
#line 2607 "y.tab.c"
    break;

  case 61:
#line 752 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2613 "y.tab.c"
    break;

  case 62:
#line 754 "../parse/parse.y"
                        {
			  COMMAND *tc;
...
#line 2633 "y.tab.c"
  ...
  case 63:
#line 770 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2639 "y.tab.c"
    break;

  case 64:
#line 772 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2645 "y.tab.c"
    break;

  case 65:
#line 776 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2651 "y.tab.c"
    break;

  case 66:
#line 778 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2657 "y.tab.c"
    break;

  case 67:
#line 780 "../parse/parse.y"
                        { (yyval.command) = make_while_command ((yyvsp[-3].command), (yyvsp[-1].command)); }
#line 2663 "y.tab.c"
    break;

  case 68:
#line 782 "../parse/parse.y"
                        { (yyval.command) = make_until_command ((yyvsp[-3].command), (yyvsp[-1].command)); }
#line 2669 "y.tab.c"
    break;

  case 69:
#line 784 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2675 "y.tab.c"
    break;

  case 70:
#line 786 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2681 "y.tab.c"
    break;

  case 71:
#line 788 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2687 "y.tab.c"
    break;

  case 72:
#line 790 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2693 "y.tab.c"
    break;

  case 73:
#line 792 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2699 "y.tab.c"
    break;

  case 74:
#line 794 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2705 "y.tab.c"
    break;

  case 75:
#line 796 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 2711 "y.tab.c"
    break;

  case 76:
#line 800 "../parse/parse.y"
                        {
...
#line 3224 "y.tab.c"
  ...
  case 140:
#line 1124 "../parse/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), AND_AND); }
#line 3230 "y.tab.c"
    break;

  case 141:
#line 1126 "../parse/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), OR_OR); }
#line 3236 "y.tab.c"
    break;

  case 142:
#line 1128 "../parse/parse.y"
                        {
...
#line 3247 "y.tab.c"
  ...
  case 143:
#line 1135 "../parse/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), ';'); }
#line 3253 "y.tab.c"
    break;

  case 144:
#line 1137 "../parse/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), ';'); }
#line 3259 "y.tab.c"
    break;

  case 145:
#line 1139 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 3265 "y.tab.c"
    break;

  case 148:
#line 1147 "../parse/parse.y"
                { (yyval.number) = '\n'; }
#line 3271 "y.tab.c"
    break;

  case 149:
#line 1149 "../parse/parse.y"
                { (yyval.number) = ';'; }
#line 3277 "y.tab.c"
    break;

  case 150:
#line 1151 "../parse/parse.y"
                { (yyval.number) = yacc_EOF; }
#line 3283 "y.tab.c"
    break;

  case 153:
#line 1165 "../parse/parse.y"
                        {
			  (yyval.command) = (yyvsp[0].command);
			  if (need_here_doc)
			    gather_here_documents ();
...
#line 3337 "y.tab.c"
  ...
  case 156:
#line 1209 "../parse/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), AND_AND); }
#line 3343 "y.tab.c"
    break;

  case 157:
#line 1211 "../parse/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), OR_OR); }
#line 3349 "y.tab.c"
    break;

  case 158:
#line 1213 "../parse/parse.y"
                        {
			  if ((yyvsp[-2].command)->type == cm_connection)
...
#line 3360 "y.tab.c"
  ...
  case 159:
#line 1220 "../parse/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-2].command), (yyvsp[0].command), ';'); }
#line 3366 "y.tab.c"
    break;

  case 160:
#line 1223 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 3372 "y.tab.c"
    break;

  case 161:
#line 1227 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 3378 "y.tab.c"
    break;

  case 162:
#line 1229 "../parse/parse.y"
                        {
			  if ((yyvsp[0].command))
...
#line 3447 "y.tab.c"
  ...
  case 166:
#line 1284 "../parse/parse.y"
                        { (yyval.command) = command_connect ((yyvsp[-3].command), (yyvsp[0].command), '|'); }
#line 3453 "y.tab.c"
    break;

  case 167:
#line 1286 "../parse/parse.y"
                        {
...
#line 3480 "y.tab.c"
  ...
  case 168:
#line 1309 "../parse/parse.y"
                        { (yyval.command) = (yyvsp[0].command); }
#line 3486 "y.tab.c"
    break;

  case 169:
#line 1313 "../parse/parse.y"
                        { (yyval.number) = CMD_TIME_PIPELINE; }
#line 3492 "y.tab.c"
    break;

  case 170:
#line 1315 "../parse/parse.y"
                        { (yyval.number) = CMD_TIME_PIPELINE|CMD_TIME_POSIX; }
#line 3498 "y.tab.c"
    break;

  case 171:
#line 1317 "../parse/parse.y"
                        { (yyval.number) = CMD_TIME_PIPELINE|CMD_TIME_POSIX; }
#line 3504 "y.tab.c"
    break;

  case 172:
#line 1319 "../parse/parse.y"
                        { (yyval.number) = CMD_TIME_PIPELINE|CMD_TIME_POSIX; }
#line 3510 "y.tab.c"
    break;
...
#endif
char *
sh_single_quote_dollar (char *string)
{
  register int c;
  char *result, *r, *s;

  result = (char *)xmalloc (4 + (4 * strlen (string)));
  r = result;
  *r++ = '$';
  *r++ = '\'';
...
char *
sh_mkdoublequoted_dollar (s, slen, flags)
     const char *s;
     int slen, flags;
{
  char *r, *ret;
      ...
      if (shellexp (character))
	{
	  ...
	  /* This handles $'...' and $"..." new-style quoted strings. */
	      ...
	      if (peek_char == '\'')
		{
		  ...
		  ttok = sh_single_quote_dollar(ttrans);
		  free (ttrans);
	      ...
	      else
		{
		  ...
		  ttok = sh_mkdoublequoted_dollar (ttrans, ttranslen, 0);
		  free (ttrans);
		  ttranslen += 3;
		  ttrans = ttok;
		}
